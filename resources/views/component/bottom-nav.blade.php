<footer class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.02)] flex justify-around py-3 pb-6 z-30 max-w-[480px] mx-auto left-0 right-0">
    ...
    <a href="{{ route('menu.index') }}" class="flex flex-col items-center gap-1 w-1/5 group">
        {{-- Jika aktif pakai ph-fill (isi penuh), jika tidak pakai ph (outline) --}}
        <i class="ph-fork-knife text-2xl {{ request()->routeIs('menu.*') ? 'text-[#37967D] ph-fill' : 'text-gray-300 group-hover:text-[#37967D] ph' }} transition-colors"></i>
